 ...
 * @version $Id: news.php 283 2009-09-17 18:15:45Z xycaleth $
 */
...
if ( sizeof ($valid_posts) > 0 )
{
	...
	{
		$pagination = '<p style="text-align:' . $fn_page_align . '; color: #26a;">' . $pagination . '</p>';
		//echo $pagination;
	}
...
unset ($fn_mode, $fn_page, $fn_category, $next_page, $prev_page,
		$pagination, $fn_news_per_page, $fn_pagination,
		$fn_author, $fn_news_template, $fn_date_order);
